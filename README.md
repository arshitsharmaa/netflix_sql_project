# Netflix Movies And TV Shows Data Analysis and Analytics using SQL
...
- ***Domestic Insights:*** The top countries and the average content releases by India highlight regional content distribution. This allows the business to categorize the content distribution (Movies and TV shows) that are shown by our audience in India. By doing this **Netflix can make decision that which is better to produce TV shows or Movies in India.**
